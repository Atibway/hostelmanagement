    ...
    <div className="flex flex-col min-h-screen">
      <main className="flex-1">
        ...
        <section
          ...
          style={{
            backgroundImage:
              'url("https://png.pngtree.com/background/20230611/original/pngtree-bunk-beds-and-a-window-in-a-green-room-picture-image_3130749.jpg")',
          }}
        >
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-white md:text-xl">
                  Discover unique hostels worldwide and manage your bookings with ease.
                </p>
              </div>
        ...
        <section
          id="featured"
          className="w-full dark:bg-primary-foreground py-12 md:py-24 lg:py-32"
        >
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-center dark:text-white mb-12">
              Featured Hostels
            </h2>
                  ...
                  <Card key={hostel.id}>
                    ...
                    <CardFooter className="flex justify-between items-center">
                      <p className="text-lg font-bold">
                        Shs.{hostel.price} <span className="text-sm text-muted-foreground">/Semester</span>
                      </p>
            ...
            <div className="grid gap-6 lg:grid-cols-2 items-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[600px] text-gray-500 md:text-xl lg:text-base xl:text-xl dark:text-gray-400">
                  HostelWorld connects travelers with unique and affordable accommodations worldwide. Our platform makes it easy to discover, compare, and manage hostels for your next adventure.
                </p>
              </div>
