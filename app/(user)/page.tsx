...
import { BedDouble, MapPin, Calendar, Search } from 'lucide-react'
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {featuredHostels.map((hostel) => (
                <Card key={hostel.id}>
                  <CardHeader>
                    <img src={hostel.image} alt={hostel.name} className="w-full h-48 object-cover rounded-t-lg" />
                  </CardHeader>
                  <CardContent>
                  ...
                  <CardFooter className="flex justify-between items-center">
                    <span className="text-lg font-bold">${hostel.price}/night</span>
                    <Link
                    href={"/hostel/34"}
                    >
